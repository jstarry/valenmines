...
var GameStateButton = React.createClass({displayName: "GameStateButton",
  ...
  render: function() {
    ...
    return (
      React.createElement("div", {className: classes, onMouseUp: this.handleMouseUp, onMouseDown: this.handleMouseDown, 
